    ...
    with tempfile.TemporaryDirectory() as tmp_dir:
        ...
        if "data_check" in active_steps:
            _ = mlflow.run(
                ...
                env_manager="local",
                parameters={
                    "csv": "models-western-governors-university2633/nyc_airbnb/clean_sample.csv:latest",
                    "ref": "models-western-governors-university2633/nyc_airbnb/clean_sample.csv:reference",
